...
mod tests {
    ...
    async fn disable_enable() {
        ...
        assert_eq!(first_subdomain_page_response.text().as_bytes(), "index\n".as_bytes());
        assert_eq!(second_subdomain_page_response.text().as_bytes(), "index\n".as_bytes());
        ...
        assert_eq!(should_be_503_page_response.text().as_bytes(), "503\n".as_bytes());
        assert!(should_not_be_503_page_response.text().as_bytes().is_empty());
